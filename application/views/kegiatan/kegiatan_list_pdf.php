<?php
    ...
    $this->fpdf->Cell(17,0.7,'LIST KEGIATAN',0,0,'C');
    $this->fpdf->Ln();
    ...
    $this->fpdf->Cell(3 , 1, 'Instansi' , 1, 'LR', 'C');
    $this->fpdf->Cell(3 , 1, 'Tanggal' , 1, 'LR', 'C');
    $this->fpdf->Cell(3 , 1, 'Mulai Proyek' , 1, 'LR', 'C');
    $this->fpdf->Cell(3 , 1, 'Selesai Proyek' , 1, 'LR', 'C');
    ...
    foreach($kegiatan_list as $data)
    {
        ...
        $this->fpdf->Cell(3 , 0.7, $data->instansi , 1, 'LR', 'L');
        $this->fpdf->Cell(3 , 0.7, $data->tanggal , 1, 'LR', 'L');
        $this->fpdf->Cell(3 , 0.7, $data->proyek_mulai , 1, 'LR', 'L');
        $this->fpdf->Cell(3 , 0.7, $data->proyek_selesai , 1, 'LR', 'L');
    }
