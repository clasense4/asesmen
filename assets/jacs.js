...
//******************************************************************************
     ...
     document.writeln(
        '<style type="text/css">' +
            '.jacs, .jacsStatic {padding:1px;vertical-align:middle;border:none;margin-top:0px;margin-left:0px;}' +
            'iframe.jacs        {position:absolute;visibility:hidden;border:none;' +
                                'top:0px;left:0px;width:1px;height:1px;}' +
            'table.jacs, ' +
            'table.jacsStatic   {padding:0px;visibility:hidden;width:240px;margin-left:0px;' +
                                'cursor:default;text-align:center;}' +
            'table.jacs         {top:0px;left:0px;position:absolute;margin-left:0px;}' +
        '</style>'  );
    ...
    // This style sheet can be extracted from the script and edited into regular
     ...
     document.writeln(
        '<style type="text/css">' +
            ...
            'table.jacs,' +
            'table.jacsStatic   {padding:       0px;' +
                                'vertical-align:middle;' +
                                'margin:		0px;' +
                                
                                'border:        ridge 2px;' +
                                'font-size:     6pt;' + //ukuran tulisan pada select box bulan dan tahun
                                'font-family:   Verdana;' +
                                'font-weight:   bold;}' +
            'td.jacsDrag,' +
            'td.jacsHead                 {padding:       0px;' +
            							 'border:		 none;'+
            							 'margin: 		 0px; '+
                                         'text-align:    center;}' +
            'td.jacsDrag                 {font-size:     8pt;border:none}' +
            'select.jacsHead             {margin:        0px; width:60px;}' + //select box bulan dan tahun
            'input.jacsHead              {height:        22px;' +
                                         'width:         22px;' + // button < dan > untuk pindah bulan
                                         'vertical-align:middle;' +
                                         'text-align:    center;' +
                                         'margin:        2px 1px;' +
                                         'font-weight:   bold;' +
            ...
            'td.jacsWeek                 {padding:       0px;' +  // M, T, W, T, F, S, S
                                         'text-align:		 right;' +
                                         'border: none;' +
                                         //'font-size:     10pt;' +
                                         'font-weight:   bold;}' +
            ...
            '/* Calendar background */' +
            'table.jacs,' +
            'table.jacsStatic            {background-color:  #D1D9F0;}' + //warna background
            '/* Drag Handle */' +
            ...
            'td.jacsWeekNumberHead       {color:             #6666CC;' +
            							 'border:            none;}'+
            '/* Week day headings */' +
            'td.jacsWeek                 {color:             #FFFFFF;' + // old #CCCCCC
            							 'border:            none;}'+
            '/* Week numbers */' +
            ...
            '/* Enabled Days */' +
            '/* Week Day */' +
            'td.jacsCells                {background-color:  #FFFFFF;' + //old #CCCCCC
            							 'border-left:            none;' +
            							 'margin-left:       13px;'+
            							 'padding:           5px;' +
                                         'color:             #000000;' +
            ...
            'td.jacsInputDate            {background-color:  #CC9999;' +
                                         ...
                                         'font-weight:bold}' +
            '/* Weekend Day */' +
            'td.jacsCellsWeekend         {background-color:  #FFFFFF;' + //old #CCCCCC
                                         'color:             #CC6666;' +
                                         'border:            none;' +
                                         'font-weight:normal}' +
            '/* Day outside the current month */' +
            'td.jacsCellsExMonth         {background-color:  #FFFFFF;' + //old #CCCCCC
                                         'color:             #666666;' +
                                         'border:            none;' +
                                         'font-weight:normal}' +
            '/* Today selector */' +
     ...
     return {show: function(ele)
             ...
             make: function (calId)
                {cals.push(calId);
                 ...
                 else   {if (!getEl('jacsSpan'+calId)) {document.writeln("<span style='border:none' id='jacsSpan"+calId+"'></span>");}
